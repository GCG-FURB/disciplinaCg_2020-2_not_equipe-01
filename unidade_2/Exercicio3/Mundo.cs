...
namespace gcgcg
{
  class Mundo : GameWindow
  {
    ...
    // circulo 1 - topo
    obj_Circulo = new Circulo("C", null, new Ponto4D(0, 100), 100);
    obj_Circulo.ObjetoCor.CorR = 0; obj_Circulo.ObjetoCor.CorG = 0; obj_Circulo.ObjetoCor.CorB = 0;
    objetosLista.Add(obj_Circulo);
    objetoSelecionado = obj_Circulo;

    // circulo 2 - direita
    obj_Circulo = new Circulo("C", null, new Ponto4D(100, -100), 100);
    obj_Circulo.ObjetoCor.CorR = 0; obj_Circulo.ObjetoCor.CorG = 0; obj_Circulo.ObjetoCor.CorB = 0;
    objetosLista.Add(obj_Circulo);
    objetoSelecionado = obj_Circulo;
    ...
    obj_SegReta = new SegReta("S", null, new Ponto4D(0, 100), new Ponto4D(-100,-100));
    obj_SegReta.ObjetoCor.CorR = 87; obj_SegReta.ObjetoCor.CorG = 199; obj_SegReta.ObjetoCor.CorB = 212;
    objetosLista.Add(obj_SegReta);
    objetoSelecionado = obj_SegReta;

    // reta 2 - linha bottom
    obj_SegReta = new SegReta("S", null, new Ponto4D(-100, -100), new Ponto4D(100, -100));
    obj_SegReta.ObjetoCor.CorR = 87; obj_SegReta.ObjetoCor.CorG = 199; obj_SegReta.ObjetoCor.CorB = 212;
    objetosLista.Add(obj_SegReta);
    objetoSelecionado = obj_SegReta;

    // reta 3 - linha direita
    obj_SegReta = new SegReta("S", null, new Ponto4D(100, -100), new Ponto4D(0, 100));
    obj_SegReta.ObjetoCor.CorR = 87; obj_SegReta.ObjetoCor.CorG = 199; obj_SegReta.ObjetoCor.CorB = 212;
    objetosLista.Add(obj_SegReta);
    objetoSelecionado = obj_SegReta;
